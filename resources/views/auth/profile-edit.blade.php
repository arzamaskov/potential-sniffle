        ...
        <main class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <a
                    ...
                    class="inline-flex min-h-10 shrink-0 items-center justify-center rounded-md border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:border-gray-300 hover:bg-gray-50 hover:text-gray-950 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
                >
                    Отмена
                </a>
            </div>
            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div class="grid gap-4 lg:grid-cols-[minmax(0,1.25fr)_minmax(320px,0.75fr)]">
                    <section class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                        <div class="mb-5 flex items-baseline justify-between gap-4">
                            ...
                            <span class="text-xs font-medium text-gray-400">необязательно</span>
                        </div>
                ...
                <div class="flex flex-col-reverse gap-3 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:flex-row sm:justify-end">
                    <a
                        href="{{ route('profile', absolute: false) }}"
